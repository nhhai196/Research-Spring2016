...
\begin{theorem}
Let $M$ be a distribution with min entropy $k$ over $\{0 , 1 \}^n$, let $G_0, G$ be $1 by \frac{n}{2}$ and $\frac{n}{2} by n$ matrices respectively, and let $X$ be a distribution over $\{ 0, 1 \} ^ \frac{n}{2}$. Then 
