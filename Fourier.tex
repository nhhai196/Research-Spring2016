...
\begin{theorem}
Let $M$ be a distribution with min entropy $k$ over $\{0 , 1 \}^n$, let $G_0, G$ be $1 \times \frac{n}{2}$ and $\frac{n}{2} \times n$ matrices respectively, and let $X$ be a distribution over $\{ 0, 1 \} ^ \frac{n}{2}$. Then 
$$SD \{ (XG_0, XG \oplus M, G_0, G), (U, XG \oplus M, G_0, G) \} \leq \frac{1}{2^k}$$
\end{theorem}

\begin{proof}
For simplicity, let $A = (XG_0, XG \oplus M | G_0 , G)$ and 
$B = (U, XG \oplus M | G_0 , G)$.
\begin{align*}
& SD \{ (XG_0, XG \oplus M, G_0, G), (U, XG \oplus M, G_0, G) \} \\
= & \underset{G_0, G} {\mathbb{E}} \left[
	SD (A,B) \right] \\
= & \underset{G_0, G} {\mathbb{E}} \left[
	\frac{1}{2} \sum\limits_{i,j} | A(i)- B (i)| \right] \\
\leq & \frac{1}{2} \underset{G_0, G} {\mathbb{E}} \left[ \sqrt{
	2N \cdot \sum\limits_{i} ((A(i) - B(i) )^2 } \right] \\	
\leq & \frac{\sqrt{2N}}{2} \sqrt{ \underset{G_0, G} {\mathbb{E}} \left[ 
	\sum\limits_{i} (A(i) - B(i) )^2 \right] } \\
= & \frac{\sqrt{2N}}{2} \sqrt{
...
\section{Statistical Different between Two Joint Distributions}
\begin{theorem}
